...
/******************************************************************************/
/*                                                                            */
/*  Defines some macros to make it easier to update the user's environment    */
/*  variables at product installation time...    (Found on NSIS web site)     */
/*                                                                            */
/*  Usage:                                                                    */
/*                                                                            */
/*    !AddIncludeDir  "${NSISDIR}\include\local"                              */
/*                                                                            */
/*    !include "EnvVar.nsh"          ; Need to update user's environ vars     */
/*                                                                            */
/*    Push  "INCLUDE"                ; variable name                          */
/*    Push  "$INSTDIR\include"       ; directory to add                       */
/*    Call  AddToEnvVar              ; append to variable                     */
/*                                                                            */
/*    Push  "LIB"                    ; variable name                          */
/*    Push  "$INSTDIR\lib"           ; directory to add                       */
/*    Call  AddToEnvVar              ; append to variable                     */
/*                                                                            */
/*                                                                            */
...
/*  Change History:                                                           */
/*                                                                            */
/*  10/31/07   Fish   Use !define AddToPathOnly switch to skip AddToEnvVar    */
/*                                                                            */
/******************************************************************************/
